      ...
      <div className="side-navbar-wrapper">
        ...
        <div className="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div className="sidenav-header-inner text-center">
            <img
              src="https://i.ibb.co/cDkYcjP/communitylogo1.png"
              alt="logo"
        ...
        <div className="main-menu">
          <ul id="side-main-menu" className="side-menu list-unstyled">
            ...
            <li>
              <Link to="/feed">
                <i className="fa fa-list-alt text-success"></i>Feed
              </Link>
            </li>
              ...
              <React.Fragment>
                ...
                <li>
                  ...
                  >
                    ...
                    <li>
                      <Link to="/goalsReport">
                        <i className="fa fa-file-text-o text-success"></i>Goals
                        Reports
                      </Link>
                    </li>
                    <li>
                      <Link to="/notesReport">
                        <i className="fa fa-file-text-o text-success"></i>Notes
                        Reports
                      </Link>
                    </li>
                  </ul>
            ...
            {roleType === "admin" && (
              <li>
                <a
                  href="#exampledropdownDropdownAdmin"
                  aria-expanded="false"
                  data-toggle="collapse"
                >
                  {" "}
                ...
                <ul
                  id="exampledropdownDropdownAdmin"
                  class="collapse list-unstyled"
                >
                  <li>
                  ...
                  <li>
                    <Link to="/adminDeleteUsers">
                      <i className="fa fa-user-circle-o text-success"></i>Delete
                      User
                    </Link>
                  </li>
                </ul>
